...
/** Inline pictograms carried over from the original markup. */
...
export function TravelIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M3 13l8-2 4-7 2 1-2 7 6 2v2l-7-1-2 4-2-1 .5-3.5L4 16z" />
    </svg>
  );
}
...
export function ForestIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <path d="M12 22v-3" />
      <path d="M8 19l4-9 4 9H8z" />
      <path d="M4 22v-2" />
      <path d="M2 20l2-5 2 5H2z" />
      <path d="M20 22v-2" />
      <path d="M18 20l2-5 2 5h-4z" />
    </svg>
  );
}
...
/** Renders one of the amenity pictograms in /public/Icons as a solid-colour mask. */
